        ...
        <div className="flex flex-wrap justify-center items-center gap-3 max-w-lg mx-auto">
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.label}
                className="group flex items-center gap-2 px-3.5 py-1.5 rounded-md border border-border/30 bg-secondary/5 hover:bg-secondary/10 hover:border-foreground/20 transition-all duration-300 cursor-default"
              >
