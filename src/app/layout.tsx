...
import { Geist, Geist_Mono, Merriweather, Nunito, Moon_Dance } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${merriweather.variable} ${nunito.variable} ${moonDance.variable} antialiased min-h-screen flex flex-col`}
      >
        <AppConvexProvider>
        <SiteStructuredData />
        <ThemeProvider
