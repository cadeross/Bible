...
function DayDetail({ day, onClose }: { day: LiturgicalDay; onClose: () => void }) {
    ...
    return (
        <motion.div
            ...
            className="border border-border/30 rounded-md p-6 space-y-5 bg-card/50 backdrop-blur-sm"
        >
            {/* Header */}
...
function CalendarDayCell({
    ...
    return (
        <motion.button
            ...
            onClick={onClick}
            className={cn(
                "group relative flex flex-col items-start p-2 md:p-3 rounded-md transition-all duration-200 text-left min-h-[60px] md:min-h-[90px] w-full border border-border/20",
...
function MobileListItem({
    ...
    return (
        <motion.button
            ...
            onClick={onClick}
            className={cn(
                "flex items-center gap-3 w-full p-3 rounded-md transition-all duration-200 text-left",
                "hover:bg-muted/40",
